...
public class HssssssssMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HssssssssMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StormlightModModMenus.HSSSSSSSS.get(), id);
