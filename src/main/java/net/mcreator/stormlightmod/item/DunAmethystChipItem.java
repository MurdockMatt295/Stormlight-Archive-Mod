...
import net.mcreator.stormlightmod.procedures.DunAmethystChipItemInInventoryTickProcedure;
import net.mcreator.stormlightmod.procedures.DunAmethystBromeRightClickedInAirProcedure;

import java.util.List;

public class DunAmethystChipItem extends Item {
	public DunAmethystChipItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		DunAmethystChipItemInInventoryTickProcedure.execute(world, entity);
	}
}
