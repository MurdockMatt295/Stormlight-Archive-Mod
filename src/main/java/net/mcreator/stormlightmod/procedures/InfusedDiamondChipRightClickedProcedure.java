...
public class InfusedDiamondChipRightClickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.INFUSED_DIAMOND_CHIP.get());
		...
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.DUN_DIAMOND_CHIP.get());
			entity.getCapability(StormlightModModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
