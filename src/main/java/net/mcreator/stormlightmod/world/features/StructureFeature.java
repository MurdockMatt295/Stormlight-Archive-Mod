package net.mcreator.stormlightmod.world.features;
...
import net.mcreator.stormlightmod.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, StormlightModMod.MODID);
