...
public class ShadesmarTrunkDecorator extends TrunkVineDecorator {
	public static Codec<ShadesmarTrunkDecorator> CODEC = Codec.unit(ShadesmarTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("shadesmar_tree_trunk_decorator", DECORATOR_TYPE));
	}
