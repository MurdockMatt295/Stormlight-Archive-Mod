...
public class NoSleepGuyEntity extends Monster {
	public NoSleepGuyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(StormlightModModEntities.NO_SLEEP_GUY.get(), world);
	}

	public NoSleepGuyEntity(EntityType<NoSleepGuyEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
