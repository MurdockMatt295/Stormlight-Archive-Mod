...
public class HighSprenRenderer extends HumanoidMobRenderer<HighSprenEntity, HumanoidModel<HighSprenEntity>> {
	...
	public ResourceLocation getTextureLocation(HighSprenEntity entity) {
		return new ResourceLocation("stormlight_mod:textures/entities/highsprentry1.png");
	}
}
