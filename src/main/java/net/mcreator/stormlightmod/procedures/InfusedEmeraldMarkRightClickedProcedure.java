...
public class InfusedEmeraldMarkRightClickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.INFUSED_EMERALD_MARK.get());
		...
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.DUN_EMERALD_MARK.get());
			entity.getCapability(StormlightModModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
