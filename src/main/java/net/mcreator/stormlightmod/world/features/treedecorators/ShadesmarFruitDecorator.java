...
package net.mcreator.stormlightmod.world.features.treedecorators;
...
public class ShadesmarFruitDecorator extends CocoaDecorator {
	public static Codec<ShadesmarFruitDecorator> CODEC = Codec.unit(ShadesmarFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("shadesmar_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public ShadesmarFruitDecorator() {
		super(0.2f);
	}
