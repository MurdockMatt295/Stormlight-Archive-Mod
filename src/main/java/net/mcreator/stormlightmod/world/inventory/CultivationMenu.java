...
public class CultivationMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CultivationMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StormlightModModMenus.CULTIVATION.get(), id);
