...
public class SkybreakerMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SkybreakerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(StormlightModModMenus.SKYBREAKER.get(), id);
