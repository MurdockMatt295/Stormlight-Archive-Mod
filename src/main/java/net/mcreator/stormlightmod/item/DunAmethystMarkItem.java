...
import net.mcreator.stormlightmod.procedures.DunAmethystMarkItemInInventoryTickProcedure;
import net.mcreator.stormlightmod.procedures.DunAmethystBromeRightClickedInAirProcedure;

import java.util.List;

public class DunAmethystMarkItem extends Item {
	public DunAmethystMarkItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		DunAmethystMarkItemInInventoryTickProcedure.execute(world, entity);
	}
}
