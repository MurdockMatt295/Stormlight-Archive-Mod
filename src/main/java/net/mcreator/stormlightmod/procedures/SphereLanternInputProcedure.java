...
public class SphereLanternInputProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == StormlightModModBlocks.SPHERE_LANTERN.get()
			...
			world.setBlock(BlockPos.containing(x, y, z), StormlightModModBlocks.SPHERE_LANTERN_INFUSED.get().defaultBlockState(), 3);
		}
	}
}
