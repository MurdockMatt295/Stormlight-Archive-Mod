...
public class InfusedHeliodorChipRightClickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.INFUSED_HELIODOR_CHIP.get());
		...
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.DUN_HELIODOR_CHIP.get());
			entity.getCapability(StormlightModModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
