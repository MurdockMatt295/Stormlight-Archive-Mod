...
import net.mcreator.stormlightmod.procedures.DunZirconchiprightProcedure;
import net.mcreator.stormlightmod.procedures.DunZirconChipItemInInventoryTickProcedure;

import java.util.List;

public class DunZirconChipItem extends Item {
	public DunZirconChipItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		DunZirconchiprightProcedure.execute(entity);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		DunZirconChipItemInInventoryTickProcedure.execute(world, entity);
	}
}
