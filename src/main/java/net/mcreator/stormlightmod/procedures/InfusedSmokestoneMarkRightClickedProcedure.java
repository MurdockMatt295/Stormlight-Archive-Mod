...
public class InfusedSmokestoneMarkRightClickedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.INFUSED_SMOKESTONE_MARK.get());
		...
		{
			ItemStack _setval = new ItemStack(StormlightModModItems.DUN_SMOKESTONE_MARK.get());
			entity.getCapability(StormlightModModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
